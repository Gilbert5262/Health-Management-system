...
<html>
 ...
 <center>  
    <div>
              <form action="payfordrugs" method="POST">
                     ...
                     <tr height: 30px">
                             ...
                             <h5><i>Account Name: <b>${fname} ${mname} ${lname}</b></i></h5>
                               ...
                               <tr>
                                   ...
                                   <td><input type="text" size="12" name="drugsfee" readonly = "readonly" value = "Drugs Fee" style = "font-size: 20px; color: red"></td>
                                   <td> <input type="submit" style="width: 50px; height: 35px; font-size: 15px" value="Go" class="btn btn-success" name="searchbill"/></td>
                                   <td> <input type="text" name="amount" placeholder="Amount" value="${totaldrugs}" size="6"/></td>
                                   <td> <input type="submit" style="width: 100px; height: 35px; font-size: 15px" value="Details" class="btn btn-success" name="getdrugdetails"/>
                                </td>
                                   ...
                                   <td><select name="paymethod">
                                    ...
                                    <td><input style="width: 100px; height: 35px;" type="submit" value="pay" class="btn btn-success" name="pay1"/> </td>
                               </tr>
