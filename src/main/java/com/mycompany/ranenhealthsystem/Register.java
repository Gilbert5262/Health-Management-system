...
public class Register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String _PFName = request.getParameter("patientFName");
            String _PLName = request.getParameter("patientLName");
            
            
            boolean authenticated = RegistrationService.authenticateUser(_PFName,_PLName);
