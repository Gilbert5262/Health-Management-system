<%-- 
    Document   : Accounts
    Created on : Jun 26, 2019, 9:08:51 AM
    Author     : HP
--%>
 ...
 <center>  
    <div>
            ...
            <table border="2">              
                 ...
                 <tr style>
                  <td colspan="5">
                     <h5><i>Account Records</i></h5>
                        </td>
                            </tr>
                               <tr>
                                   
                                         <td><input style="width: 150px; height: 35px;" type="submit" value="Print Receipt" class="btn btn-success" name="PrintReceipt"/></td>                               
                                      <td><input style="width: 150px; height: 35px;" type="submit" value="Payment History" class="btn btn-success" name="PaymentHistory"/></td>
                                      <td><input style="width: 150px; height: 35px;" type="submit" value="Account Reports" class="btn btn-success" name="Accout Reports"/></td>
                                      <td><input style="width: 150px; height: 35px;" type="submit" value="Account Records" class="btn btn-success" name="Accout Records"/></td>
